...
export const masterNavigation = [
  ...
  { id: "fds",           label: "FDS — Studio",     icon: Sparkles,      path: "/fds",          requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds_fees:view","fds:management"],  group: "fds", category: "divisions", description: "Dance studio overview & KPIs" },
  { id: "fdsEnquiry",    label: "FDS Enquiries",    icon: Users,         path: "/fds/enquiries", requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds:management"],                group: "fds", category: "divisions", description: "Studio leads & walk-in enquiries" },
  { id: "fdsTrial",      label: "FDS Trials",       icon: Star,          path: "/fds/trials",    requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds:management"],                group: "fds", category: "divisions", description: "Trial dance sessions & bookings" },
  { id: "fdsStudents",   label: "FDS Students",     icon: GraduationCap, path: "/fds/students",  requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds:management"],                group: "fds", category: "divisions", description: "Active dance students directory" },
  { id: "fdsBatches",    label: "FDS Batches",      icon: Music,         path: "/fds/batches",   requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds:management"],                group: "fds", category: "divisions", description: "Dance styles, schedules & batches" },
  { id: "fdsAttendance", label: "FDS Attendance",   icon: CalendarCheck, path: "/fds/attendance",requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds:management"],                group: "fds", category: "divisions", description: "Student class attendance" },
  { id: "fdsFees",       label: "FDS Fees",         icon: IndianRupee,   path: "/fds/fees",      requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds_fees:view","fds:management"],group: "fds", category: "divisions", description: "Studio fee payments & dues" },
  { id: "fdsFeePolicies",label: "FDS Fee Policies", icon: Settings,      path: "/fds/fee-policies",requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds_fees:view","fds:management"],group: "fds", category: "divisions", description: "Pricing plans & payment policies" },
  { id: "fdsWeddings",   label: "FDS Weddings 💍",  icon: Heart,         path: "/fds/weddings",  requiredPermissions: ["fds:admin","fds:admin_own","fds:view","fds:management"],                group: "fds", category: "divisions", description: "Wedding choreography packages" },
