...
const PERMISSION_OPTIONS = [
  { id: 'dashboard:read', label: 'View Overview', group: 'Navigation' },
  { id: 'leads:read_tenant', label: 'View Leads', group: 'Navigation' },
  { id: 'staff:read_tenant', label: 'View Staff', group: 'Navigation' },
  { id: 'students:read_tenant', label: 'View Students', group: 'Navigation' },
  { id: 'students:edit_any', label: 'Manage Students', group: 'Navigation' },
  { id: 'students:edit_tenant', label: 'Edit Tenant Students', group: 'Navigation' },
  { id: 'students:edit_own', label: 'Edit Own Students', group: 'Navigation' },
  { id: 'students:registry_manage', label: 'Manage Student Registry', group: 'Navigation' },
  { id: 'students:batch_manage', label: 'Manage Academic Batches', group: 'Navigation' },
  { id: 'students:admin', label: 'Global My Students Access', group: 'Navigation' },
  { id: 'tasks:read_all', label: 'View All Tasks', group: 'Tasks' },
  { id: 'tasks:read_own', label: 'View My Tasks', group: 'Tasks' },
  { id: 'tasks:edit_any', label: 'Edit & Assign Tasks', group: 'Tasks' },
  { id: 'reports:read_all', label: 'View Staff Reports', group: 'Reports' },
  ...
  { id: 'attendance:view_docs', label: 'View Attendance Docs', group: 'HR' },
  { id: 'attendance:mark', label: 'Mark Student Attendance', group: 'Trainer' },
  { id: 'attendance:approvals', label: 'View Attendance Reports', group: 'Trainer' },
  { id: 'attendance:create', label: 'Create Attendance Docs', group: 'HR' },
  { id: 'attendance:edit_any', label: 'Edit Any Attendance', group: 'HR' },
  { id: 'attendance:edit_tenant', label: 'Edit Tenant Attendance', group: 'HR' },
  { id: 'attendance:edit_own', label: 'Edit Own Attendance', group: 'HR' },
  { id: 'candidates:read_any', label: 'View Candidates', group: 'HR' },
  { id: 'candidates:edit_any', label: 'Manage Candidates', group: 'HR' },
  { id: 'fees:read_tenant', label: 'View Fees', group: 'Fees' },
  { id: 'fees:manage', label: 'Manage Fees', group: 'Fees' },
  { id: 'fees:restructure', label: 'Restructure Fees', group: 'Fees' },
  { id: 'fees:partial_payment', label: 'Record Partial Payment', group: 'Fees' },
  { id: 'fees:issue_notice', label: 'Issue Fee Notice', group: 'Fees' },
  { id: 'fees:view_reports', label: 'View Fee Reports', group: 'Fees' },
  { id: 'fees:analytics', label: 'View Fee Analytics', group: 'Fees' },
  { id: 'assets:read_any', label: 'View Assets', group: 'HR' },
  { id: 'assets:manage', label: 'Manage Assets', group: 'HR' },
  { id: 'assets:read_tenant', label: 'View Staff Assets Tab', group: 'Staff' },
  { id: 'staff:edit_contact_logic', label: 'Manage Contact Logic', group: 'Staff' },
